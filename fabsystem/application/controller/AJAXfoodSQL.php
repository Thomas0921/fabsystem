...
if (isset($_POST['cat_id']) && isset($_POST['subcat_id']) && isset($_POST['code']) && isset($_POST['name']) && isset($_POST['description']) && isset($_POST['price'])){
  ...
  $sql = "INSERT INTO foods(food_id, food_code, food_name, food_description, food_price, subcategory_id)
  VALUES (NULL, '$code', '$name', '$description', '$price', '$subcat_id');";
