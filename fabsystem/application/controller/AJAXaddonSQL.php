...
if (isset($_POST['add_addon_id']) && isset($_POST['code']) && isset($_POST['name']) && isset($_POST['description']) && isset($_POST['price'])){
  ...
  $sql = "INSERT INTO food_add_on(add_on_id, add_on_code, add_on_name, add_on_description, add_on_price, category_id)
  VALUES (NULL, '$code', '$addon_name', '$addon_description', '$addon_price', '$add_addon_id');";
...
if (isset($_POST['update_addon_id']) && isset($_POST['code']) && isset($_POST['name']) && isset($_POST['description']) && isset($_POST['price'])){
