...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 21, 2018 at 12:08 PM
...
INSERT INTO `food_add_on` (`add_on_id`, `add_on_code`, `add_on_name`, `add_on_description`, `add_on_price`, `category_id`) VALUES
(1, '102', 'Fried Egg', '荷包蛋', '1.50', 1),
(2, '102', 'Fish Fillet', '鱼柳', '1.50', 1),
(3, '103', 'Cocktail Sausage', '迷你小香肠（3片）', '2.20', 1);
...
(4, 'Thomas', '0125421256', 'Jalan Jaguh 3');
...
(10, 0, 'jason', '02155756', 'jalan bakti 4', '<dl><dt>1 Mamee Fish Rice<button class=\'delete-item\' data-id=\'3\'>X</button><dt>1 Curry Chicken Rice<button class=\'delete-item\' data-id=\'1\'>X</button><dd>1 Fish Fillet<button class=\'delete-addon\' cat-id=\'1\' addon-id=\'2\'>X</button></dd><dd>1 Cocktail Sausage (3 pcs)<button class=\'delete-addon\' cat-id=\'1\' addon-id=\'3\'>X</button></dd></dl>', '2018-03-19 09:44:07', '2018-03-17 20:29:19', '2018-03-20 01:23:24', '56.20', '2.00', '4.00', 'JP10', 1, 2),
...
(16, 0, 'dd', '123', 'No 33, jalan guning', '<dl><dt count=1 price=8.9>1     Mamee Fish Rice<button class=\'delete-item\' data-id=\'3\'>X</button><dt count=1 price=8.9>1     Nasi Ayam Kunyit<button class=\'delete-item\' data-id=\'6\'>X</button><dt count=1 price=11.9>1     Nasi Ayam Penyet<button class=\'delete-item\' data-id=\'5\'>X</button><dt count=1 price=8.9>1     Curry Chicken Rice<button class=\'delete-item\' data-id=\'1\'>X</button><dd count=1 price=1.5>1 Fish Fillet<button class=\'delete-addon\' cat-id=\'1\' addon-id=\'2\'>X</button></dd><dd count=1 price=2.2>1 Cocktail Sausage<button class=\'delete-addon\' cat-id=\'1\' addon-id=\'3\'>X</button></dd></dl>', '2018-03-20 12:00:52', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0.00', '2.00', '4.00', 'll', 1, 1),
(17, 0, 'ss', '123123', 'No 77', '<dl><dt count=2 price=8.9>2     Curry Chicken Rice<button class=\'delete-item\' data-id=\'1\'>X</button><dd count=1 price=1.5>1 Fried Egg<button class=\'delete-addon\' cat-id=\'1\' addon-id=\'1\'>X</button></dd></dl>', '2018-03-20 12:03:24', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '32.40', '2.00', '4.00', 'ff', 1, 1),
...
(19, 3, 'Kenny ', '0126541254', '0126541254', '<dl><dt count=2 price=8.9>2     Curry Chicken Rice<button class=\'delete-item\' data-id=\'1\'>X</button><dd count=1 price=1.5>1 Fried Egg<button class=\'delete-addon\' cat-id=\'1\' addon-id=\'1\'>X</button></dd></dl>', '2018-03-21 11:03:17', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '18.80', '2.00', '4.00', 'JP0021', 1, 1),
(20, 4, 'Thomas', '0125421256', '0125421256', '<dl><dt total_each_food=17.8>2     Curry Chicken Rice<button class=\'delete-item\' data-id=\'1\'>X</button><label id=\'display_total_food\'><dt total_each_food=8.9>1     Mamee Chicken Rice<button class=\'delete-item\' data-id=\'2\'>X</button><label id=\'display_total_food\'><dd total_each_addon=1.5>1 Fried Egg<button class=\'delete-addon\' cat-id=\'2\' addon-id=\'1\'>X</button><label id=\'display_total_addon\'></dd></dl>', '2018-03-21 17:57:25', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '21.30', '2.00', '4.00', 'JP0021', 1, 1),
(21, 3, 'Kenny ', '0126541254', '0126541254', '<dl><dt total_each_food=17.8>2     Curry Chicken Rice<button class=\'delete-item\' data-id=\'1\'>X</button><label id=\'display_total_food\'><dt total_each_food=8.9>1     Mamee Chicken Rice<button class=\'delete-item\' data-id=\'2\'>X</button><label id=\'display_total_food\'><dd total_each_addon=1.5>1 Fried Egg<button class=\'delete-addon\' cat-id=\'2\' addon-id=\'1\'>X</button><label id=\'display_total_addon\'></dd></dl>', '2018-03-21 17:57:53', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '42.30', '2.00', '5.00', '3', 1, 1),
(22, 3, 'Kenny ', '0126541254', '0126541254', '<dl><dt total_each_food=17.8>2     Curry Chicken Rice<button class=\'delete-item\' data-id=\'1\'>X</button><label id=\'display_total_food\'><dt total_each_food=8.9>1     Mamee Chicken Rice<button class=\'delete-item\' data-id=\'2\'>X</button><label id=\'display_total_food\'><dd total_each_addon=1.5>1 Fried Egg<button class=\'delete-addon\' cat-id=\'2\' addon-id=\'1\'>X</button><label id=\'display_total_addon\'></dd></dl>', '2018-03-21 18:15:18', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '30.20', '2.00', '4.00', 'JP0021', 1, 1);
